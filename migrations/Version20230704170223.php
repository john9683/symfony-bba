 ...
 */
final class Version20230704170223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ADD first_name VARCHAR(90) NOT NULL');
        $this->addSql('ALTER TABLE "user" ADD subscription_level VARCHAR(90) DEFAULT NULL');
